...
$(function () {
    ...
    $("#content").css("width", $loveHeart.width() + $("#codes").width() + 60);
    $("#content").css("height", Math.max($loveHeart.height(), $("#codes").height()));
...
function adjustWordsPosition() {
    ...
    $('#words').css("top", $("#garden").position().top + 215);
    $('#words').css("left", $("#garden").position().left + 130);
}

function adjustCodePosition() {
    $('#codes').css("margin-top", ($("#garden").height() - $("#codes").height()) / 2);
}
